...
Call getConsentForEU method to automatically handle the consent and forms inside the current activity. This method provides a callback with success and failure listener, handle
them in your app.
 ...
 * @param appLovinConfigBuilder -> Pass the AppLovinSdkInitializationConfiguration.Builder instance created with your key here.
...
AdSdk.initialize(
    ...
    appLovinConfigBuilder = AppLovinSdkInitializationConfiguration.builder(
        "pA3NAGLWSFkdUbKoK9gLEDnpXe6x8XU6D2TgT5vsHlZXt4FATcoLWTvA3fHBVhG6hh********************",
        application
    ),
